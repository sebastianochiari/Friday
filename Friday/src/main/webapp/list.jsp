...
<c:if test="${passaggioServlet eq true}">
    <div class="clearfix">
        ...
        <div class="float-right">
            ...
            <!-- GEOLOCALIZZAZIONE -->
            <a href="#" class="shopping-link list-icon" title="Map" data-toggle="modal" data-target="#mapModal">
            ...
            <div class="modal fade" id="mapModal" tabindex="-1" role="dialog" aria-labelledby="mapModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content shadow">
                        <div class="modal-header">
                            <h5 class="modal-title">Negozi nelle vicinanze</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <input type="hidden" value="${listacorrente[4]}" id="LCID">
